package com.areandina.database.mysql;



import com.areandina.database.DataBase;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

import static com.areandina.database.mysql.MySqlConstants.CONNECTION_STRING;
import static com.areandina.database.mysql.MySqlConstants.MY_SQL_JDBC_DRIVER;
